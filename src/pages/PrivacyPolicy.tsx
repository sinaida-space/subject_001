    ...
    <div className="min-h-screen bg-background py-24">
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="prose prose-invert font-clinical text-sm text-secondary-foreground space-y-6 leading-relaxed">
          ...
          <p className="text-muted-foreground">You can set your browser not to accept cookies. However, in a few cases, some of my website features (such as custom fonts or interactive elements) may not function as a result.</p>
