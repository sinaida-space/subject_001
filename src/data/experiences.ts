...
export const DARIA_PROJECTS: ExperienceProject[] = [
  {
    ...
    images: [
      ...
      { src: '/experiences/mipim-cannes-2025/06.jpg', alt: 'Two-floor pavilion exterior by day, Invest Saudi and Diriyah signage over the entrances, visitors on the red carpet' },
      { src: '/experiences/mipim-cannes-2025/07.jpg', alt: 'Illuminated architectural terrain model on a curved plinth, staffed reception desk to the left, ceiling projectors' },
      { src: '/experiences/mipim-cannes-2025/08.jpg', alt: 'Terrain model in the foreground, a screen showing figures in traditional dress, bar seating behind gold panel doors' },
    ],
  },
  {
