...
export const DARIA_PROJECTS: ExperienceProject[] = [
  {
    ...
    images: [
      ...
      { src: '/experiences/mipim-cannes-2025/03.png', alt: 'Invest Saudi pavilion at MIPIM Cannes 2025, upper-floor lounge area' },
      ...
      { src: '/experiences/mipim-cannes-2025/06.png', alt: 'Invest Saudi pavilion at MIPIM Cannes 2025, exterior facade at night' },
      { src: '/experiences/mipim-cannes-2025/07.png', alt: 'Invest Saudi pavilion at MIPIM Cannes 2025, structural floor plan' },
  ...
  },
  {
    ...
    images: [
      { src: '/experiences/smart-city-barcelona/01.png', alt: 'New Murabba booth at Smart City Expo World Congress Barcelona, central LED cube' },
      { src: '/experiences/smart-city-barcelona/02.png', alt: 'New Murabba booth at Smart City Expo World Congress Barcelona, booth overview' },
      ...
      { src: '/experiences/smart-city-barcelona/04.jpeg', alt: 'New Murabba booth at Smart City Expo World Congress Barcelona, LED cube content close-up' },
      { src: '/experiences/smart-city-barcelona/05.jpeg', alt: 'New Murabba booth at Smart City Expo World Congress Barcelona, seating and meeting zone' },
      { src: '/experiences/smart-city-barcelona/06.png', alt: 'New Murabba booth at Smart City Expo World Congress Barcelona, structural floor plan' },
