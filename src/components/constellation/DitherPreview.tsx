...
// ── Floating dithered project preview (issue #20) ──
// A specimen-tag-style square that trails the cursor while hovering a row
// in the plain signal index. Dark mode only; the dither itself runs once
// per image (see ditherPreview.ts) and is cached, so steady-state cost here
// is just a rAF-driven transform lerp — no per-frame canvas work.
