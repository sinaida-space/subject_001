            ...
            <div>
              ...
              <div className="space-y-3.5">
                {[
                  ...
                  <a key={link.label} href={link.url} target="_blank" rel="noopener noreferrer" className="block font-mono uppercase text-[14px] tracking-[0.15em] text-foreground/60 transition-colors hover:text-foreground cursor-none">
                    {link.label} ↗
                  </a>
                ))}
              </div>
